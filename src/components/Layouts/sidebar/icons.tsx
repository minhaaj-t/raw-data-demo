...
import {
  ...
  Graph,
  Notification as NotificationIconly,
  Setting,
} from "react-iconly";

export type PropsType = SVGProps<SVGSVGElement>;

interface IconProps extends PropsType {
  isActive?: boolean;
}

export function ChevronUp({ isActive, ...props }: IconProps) {
  return (
    <svg
      width={16}
      height={8}
...
export function Calendar({ isActive, ...props }: IconProps) {
  return (
    <svg
...
export function User({ isActive, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
...
export function Alphabet({ isActive, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
...
export function Table({ isActive, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
...
export function PieChart({ isActive, ...props }: IconProps) {
  return (
...
export function FourCircle({ isActive, ...props }: IconProps) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path
        fillRule="evenodd"
...
export function Authentication({ isActive, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
...
export function ArrowLeftIcon({ isActive, ...props }: IconProps) {
  return (
    <svg
      width="18"
      height="18"
...
// Custom chat bubble icon for Live Chat
export function LiveChatIcon({ isActive, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
