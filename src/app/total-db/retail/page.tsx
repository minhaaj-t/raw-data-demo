...
export default function RetailPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const data = await getTotalDbData("retail", urlSearchParams);
      setCustomers(data);
      setLoading(false);
    }
    fetchData();
    ...
    <Suspense fallback={<div>Loading...</div>}>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <ExportButton data={customers} filename="retail-customers" />
        </div>
        ...
        <DataTable
          ...
          emptyMessage="No retail customers found"
          loading={loading}
        />
      </div>
    </Suspense>
