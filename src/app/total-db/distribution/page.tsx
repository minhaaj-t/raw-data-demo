...
export default function DistributionPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const data = await getTotalDbData("distribution", urlSearchParams);
      setCustomers(data);
      setLoading(false);
    }
    fetchData();
  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <Breadcrumb pageName="Distribution" />
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <ExportButton data={customers} filename="distribution-customers" />
        </div>
        ...
        <DataTable
          ...
          emptyMessage="No distribution customers found"
          loading={loading}
        />
      </div>
    </Suspense>
