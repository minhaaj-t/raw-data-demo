...
export default function RestaurantPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const data = await getTotalDbData("restaurant", urlSearchParams);
      setCustomers(data);
      setLoading(false);
    }
    fetchData();
  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <Breadcrumb pageName="Restaurant" />
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <ExportButton data={customers} filename="restaurant-customers" />
        </div>
        ...
        <DataTable
          ...
          emptyMessage="No restaurant customers found"
          loading={loading}
        />
      </div>
    </Suspense>
