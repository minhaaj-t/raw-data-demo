...
export default function CompetitionPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setEvents(data.filter((e) => e.type === "competition"));
    };
    fetchData();
  }, []);
  ...
  return (
    <>
      <Breadcrumb pageName="Competition Events" />
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <ExportButton data={events} filename="competition-events" />
        </div>
        ...
        <DataTable
          ...
          columns={[
            ...
            { key: "name", header: "Competition Name", sortable: true },
            {
              key: "date",
              header: "Date",
              sortable: true,
          ...
          emptyMessage="No competition events found"
        />
      </div>
    </>
  );
