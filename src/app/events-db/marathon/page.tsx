...
export default function MarathonPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setEvents(data.filter((e) => e.type === "marathon"));
    };
    fetchData();
  }, []);
  ...
  return (
    <>
      <Breadcrumb pageName="Marathon Events" />
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <ExportButton data={events} filename="marathon-events" />
        </div>
        ...
        <DataTable
          ...
          emptyMessage="No marathon events found"
        />
      </div>
    </>
  );
