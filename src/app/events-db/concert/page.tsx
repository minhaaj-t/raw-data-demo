...
export default function ConcertPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setEvents(data.filter((e) => e.type === "concert"));
    };
    fetchData();
  }, []);
  ...
  return (
    <>
      <Breadcrumb pageName="Concert Events" />
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <ExportButton data={events} filename="concert-events" />
        </div>
        ...
        <DataTable
          ...
          columns={[
            ...
            { key: "name", header: "Concert Name", sortable: true },
            {
              key: "date",
              header: "Date",
              sortable: true,
            ...
            { key: "location", header: "Venue", sortable: true },
            {
              key: "participants",
              header: "Audience",
              sortable: true,
          ...
          emptyMessage="No concert events found"
        />
      </div>
    </>
  );
