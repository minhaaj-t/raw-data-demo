...
export default function OtherPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setEvents(data.filter((e) => e.type === "other"));
    };
    fetchData();
  }, []);
  ...
  return (
    <>
      <Breadcrumb pageName="Other Events" />
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <ExportButton data={events} filename="other-events" />
        </div>
        ...
        <DataTable
          ...
          emptyMessage="No other events found"
        />
      </div>
    </>
  );
